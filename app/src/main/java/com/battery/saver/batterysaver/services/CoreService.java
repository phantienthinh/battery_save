...
public class CoreService extends Service {
    ...
    List<com.battery.saver.batterysaver.bean.AppProcessInfo> list = null;
    ...
    public static interface OnPeocessActionListener {
        ...
        public void onScanCompleted(Context context, List<com.battery.saver.batterysaver.bean.AppProcessInfo> apps);
    ...
    private class TaskScan extends AsyncTask<Void, Integer, List<com.battery.saver.batterysaver.bean.AppProcessInfo>> {
        ...
        @Override
        protected List<com.battery.saver.batterysaver.bean.AppProcessInfo> doInBackground(Void... params) {
            list = new ArrayList<com.battery.saver.batterysaver.bean.AppProcessInfo>();
            ApplicationInfo appInfo = null;
            com.battery.saver.batterysaver.bean.AppProcessInfo abAppProcessInfo = null;
            ...
            for (AndroidAppProcess appProcessInfo : processes) {
                ...
                abAppProcessInfo = new com.battery.saver.batterysaver.bean.AppProcessInfo(
        ...
        @Override
        protected void onPostExecute(List<com.battery.saver.batterysaver.bean.AppProcessInfo> result) {
            if (mOnActionListener != null) {
