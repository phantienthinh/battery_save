package com.battery.saver.batterysaver.adapters;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
           ...
           //         .findViewById(R.id.memory);
            final Typeface tvFont = Typeface.createFromAsset(mContext.getAssets(), "Quicksand-Medium.ttf");
            holder.appName.setTypeface(tvFont);
